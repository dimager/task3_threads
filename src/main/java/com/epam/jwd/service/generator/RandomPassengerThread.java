...
public class RandomPassengerThread extends Thread {
    ...
    public Passenger generatePassenger(Airport airport) {
        if (random.nextInt(10) % 3 == 0) {
            ...
            return new Passenger(firstNameArray[random.nextInt(firstNameArray.length)], lastNameArray[random.nextInt(lastNameArray.length)], new Ticket(getFlight(airport)), randomBoolean());
        }
    }
